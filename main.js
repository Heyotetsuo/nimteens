...
var log=console.log,doc=document,win=window,hidden,BLINK_TO,BOX=false,shad,DEV=true;
...
function addShape( shape, s, o, C )
{
        ...
        if ( shape["fillStyle"] )
        {
                ...
                {
                        props = ["shadowBlur","shadowColor","shadowOffsetY"];
                        props.forEach( p=>C[p]=shape[p] );
                        C.fill();
                        props.forEach( p=>C[p]=null );
                } else {
                        C.fill();
                }
        }
...
function addHands()
{
        ...
        copy.shadowOffsetY = z(50);
        copy.shadowColor = "#00000040";
        copy.shadowBlur = CD.shadBlur;
